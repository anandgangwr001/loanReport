/// <reference path="../app/Common/commonDialog.html" />
                ...
                */
                ...
                open: function (prms) {
                    ...
                    $q.when(loadTemplate(params.template)).then(function (template) {
                        ...
                        dialogObj = angular.element('<div id="' + dialogId + '" class="dialog-main abc" vertical-center ></div>');
